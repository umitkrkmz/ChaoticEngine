...
/// <summary>
/// Implements the Chen System, a 3D dynamical system proposed by Guanrong Chen in 1999.
/// <br/>It is topologically distinct from the Lorenz system and generates a more complex "Double Scroll" attractor.
/// </summary>
public class ChenGenerator : IChaoticGenerator3D
{
    /// <summary>
    /// Parameter A (Canonical value: 35.0). Represents the Prandtl number equivalent.
    /// </summary>
    public double A { get; init; } = 35.0;

    /// <summary>
    /// Parameter B (Canonical value: 3.0). Related to the geometric aspect of the attractor.
    /// </summary>
    public double B { get; init; } = 3.0;

    /// <summary>
    /// Parameter C (Canonical value: 28.0). Acts as the Rayleigh number equivalent.
    /// </summary>
    public double C { get; init; } = 28.0;

    /// <summary>
    /// Time step (Delta T) for the Euler integration method.
    /// <br/>Default: 0.005 (Smaller values provide higher precision but require more iterations).
    /// </summary>
    ...
    /// <summary>
    /// Generates chaotic trajectories for X, Y, and Z using Chen's equations.
    /// </summary>
