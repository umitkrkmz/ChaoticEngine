...
/// <summary>
/// Implements the Hénon Map, a discrete-time dynamical system that exhibits chaotic behavior.
/// <br/>It maps a point (x, y) to a new point in the plane, often forming a "Strange Attractor" with a fractal structure.
/// </summary>
public class HenonGenerator : IChaoticGenerator2D
{
    /// <summary>
    /// Parameter A (Canonical value: 1.4).
    /// Controls the folding of the attractor. Values > 1.06 usually lead to chaos.
    /// </summary>
    public double A { get; init; } = 1.4;

    /// <summary>
    /// Parameter B (Canonical value: 0.3).
    /// Controls the dissipation/contraction of the area.
    /// </summary>
    ...
    /// <summary>
    /// Generates chaotic 2D coordinates using the Hénon Map equations.
    /// </summary>
    /// <param name="xBuffer">Buffer to store X coordinates.</param>
    /// <param name="yBuffer">Buffer to store Y coordinates.</param>
