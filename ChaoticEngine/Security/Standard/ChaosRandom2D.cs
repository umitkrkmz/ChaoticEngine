...
/// <summary>
/// A random number generator using 2D Chaotic Maps (Henon).
/// </summary>
public class ChaosRandom2D<TPrimitive> : Random where TPrimitive : struct, IChaoticPrimitive2D
{
    ...
    public ChaosRandom2D(int bufferSize = 4096)
    {
    ...
    private void RefillBuffer()
    {
        ...
        ChaosCipher2D<TPrimitive>.Process(_buffer, _key, _iv);
        _bufferIdx = 0;
    }
