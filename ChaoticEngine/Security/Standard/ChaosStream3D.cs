...
/// <summary>
/// Specialized Stream wrapper for 3D Chaotic Systems (Lorenz, Chen).
/// </summary>
public class ChaosStream3D<TPrimitive> : Stream
    where TPrimitive : struct, IChaoticPrimitive3D
{
    ...
    public ChaosStream3D(Stream baseStream, byte[] key, byte[] iv)
    {
    ...
    private void GenerateKeystreamBlock(long blockIndex)
    {
        ...
        ChaosCipher3D<TPrimitive>.Process(_keystreamBuffer, _key, counterIv);
